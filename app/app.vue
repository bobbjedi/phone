         ...
         <f7-panel left reveal resizable v-if="Store.globalRouter.navigate">
            <f7-view>
                <f7-page>
                    ...
                    <f7-link panel-close="left" @click="Store.globalRouter.navigate('/trade')">Trade</f7-link>
                    <br>
                    <f7-link panel-close="left" @click="Store.globalRouter.navigate('/login')">Login page</f7-link>
                </f7-page>
            </f7-view>
        </f7-panel>
        <!-- КОНЕЦ ЛЕВОЕ МЕНЮ -->
