        ...
        <f7-page>
            ...
            <span v-if="popupMethod === 'addAddress'">
                ...
                <f7-block>
                    ...
                    <p> Для пополнения счета {{activeCoinName}} в системе будут учитываться транзакции <b>только</b> с этого адреса. Вывод будет осуществляться также <b>только</b> на него. Поэтому будьте внимательны и храните его seed фразу в надежном месте.</p>
