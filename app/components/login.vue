...
<f7-page no-toolbar no-swipeback login-screen>
    ...
    <f7-list form>
        <f7-list-input label="Login" type="text" placeholder="Your login" :value="user.login" @input="user.login = $event.target.value"></f7-list-input>
        <f7-list-input v-if="!user.isLoginned" label="Address" type="text" placeholder="Your minter address" :value="user.address" @input="user.address = $event.target.value"></f7-list-input>
        <f7-list-input label="Password" type="password" placeholder="Your password" :value="user.password" @input="user.password = $event.target.value"></f7-list-input>
